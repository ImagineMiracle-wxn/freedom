...
<Project NoOfControllers="1" >
   ...
   set migprjfile {/vc707mig1gb.prj}
   set migprjfilepath $ipdir$migprjfile
   set fp [open $migprjfilepath w+]
   puts $fp $migprj
   close $fp
   create_ip -vendor xilinx.com -library ip -name mig_7series -module_name vc707mig1gb -dir $ipdir -force
   set_property CONFIG.XML_INPUT_FILE $migprjfilepath [get_ips vc707mig1gb] 